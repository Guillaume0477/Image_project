function [x_min,x_max,y_min,y_max] = zoom_sur_resistance(I_rotate_sans_reflet)
...
SE_resitance_largeur = strel('rectangle',[50,80]);
...
y_min = j_min+round(0.08*w);
y_max = j_max-round(0.08*w);
end
